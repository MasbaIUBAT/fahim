...
REPOS=("https://github.com/MasbaIUBAT/new-job.git" "https://github.com/MasbaIUBAT/Docker-networking-.git" "https://github.com/MasbaIUBAT/fahim.git" "https://github.com/MasbaIUBAT/new-repository.git")
# File to be pushed
FILE_NAME="rumi.txt"
